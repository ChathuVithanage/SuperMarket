...
public class administratorController {
    ...
    private void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgItem":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../MainView/ManageItemForm.fxml"));
                    break;
                case "imgReport":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../MainView/reportForm.fxml"));
                    break;
            }
