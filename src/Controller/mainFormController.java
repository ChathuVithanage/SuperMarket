        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgAdministrator":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../MainView/administratorForm.fxml"));
                    break;
                case "imgCashier":
                    mainPane = FXMLLoader.load(this.getClass().getResource("../MainView/cashierForm.fxml"));
                    break;
            }
